...
return [
    ...
    */
    ...
    'custom_permissions' => [
        'ViewHorizon' => 'مشاهده Horizon',
        'ViewManagerStatsOverviewWidget' => 'نمای کلی داشبورد',
        'ViewInvoiceSalesChartWidget' => 'نمودار فروش',
        'ViewPendingDiscountRequestsWidget' => 'درخواست‌های تخفیف در انتظار',
        'ViewReportInvoicesTableWidget' => 'جدول فاکتورهای گزارش',
        'ViewEmployeePerformanceTableWidget' => 'عملکرد کارمندان',
        'ViewPaidDiscountsTableWidget' => 'واریزهای انجام‌شده',
    ],
